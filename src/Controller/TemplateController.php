...
class TemplateController extends AbstractController
{
    ...
    /**
     * @Route("/templates/{id}/products", name="templates_get_products_collection", methods="POST", requirements={"id"="\d+"})
     */
    ...
    /**
     * @Route("/templates/{id}/products/{id}", name="templates_patch_item", methods="DELETE", requirements={"id"="\d+"})
     */
